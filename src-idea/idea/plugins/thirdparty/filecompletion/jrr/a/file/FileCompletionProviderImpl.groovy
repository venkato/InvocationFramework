...
@CompileStatic
public class FileCompletionProviderImpl extends CompletionProviderCommon {
    ...
    protected void addCompletions(
        ...
        completionBean = MyAcceptFileProviderImpl.isOkJavaAndGroovyPsiElement(psiElement3);
