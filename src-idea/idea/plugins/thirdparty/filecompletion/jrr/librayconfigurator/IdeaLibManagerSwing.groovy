...
//        editSettings.setEnabled(!SettingsRef.locationEdit.exists())
    ...
    private saveSettingsImpl() {
        ...
        FileUtils.copyFile(SettingsRef.locationEdit.resolveToFile(), SettingsRef.location.resolveToFile())
    ...
    private boolean editSetttingssImpl() {
        ...
        if (SettingsRef.location.resolveToFile().exists()) {
            FileUtils.copyFile(SettingsRef.location.resolveToFile(), SettingsRef.locationEdit.resolveToFile())
            return true
        }
