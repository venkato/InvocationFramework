...
public class ServiceLocator {
	...
	public static void allowArrayClassloader() throws Exception {
		JrrClassUtils.setFieldValue(VM.class, "allowArraySyntax", true);
		JrrClassUtils.setFieldValue(VM.class, "defaultAllowArraySyntax", true);
	}
