...
import com.jcraft.jsch.UserAuthKeyboardInteractiveOriginal
import groovy.transform.CompileStatic;
import net.sf.jremoterun.utilities.JrrClassUtils;
import java.util.logging.Logger;

@CompileStatic
class UserAuthKeyboardInteractiveJrr extends UserAuthKeyboardInteractiveOriginal implements SshAuthCallParentMethod{
