...
class QfRstaRunnerWithStackTrace extends RstaRunnerWithStackTrace2 {
    ...
    QfRstaRunnerWithStackTrace(File file, File connectFile) {
        ...
        cloneButton.addActionListener {
            ...
            QfRstaRunnerWithStackTrace newPanel = createNewWindow(fileWithConfig, fileWithConnectionConfig)
...
//        rightPanel.addTab(msgToSendView.view)
    ...
    QfRstaRunnerWithStackTrace createNewWindow(File file, File connectFile) {
        return new QfRstaRunnerWithStackTrace(file, connectFile)
    }
