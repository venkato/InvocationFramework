...
//        list
        ...
        for (int i = 0; i <parametersList.size(); i++) {
            ...
            String value1 = elI.getTargetValue().blockingGet(getTimeout)
            if(value1== '-classpath'){
                classPathEl = i+1;
            }
        }
        ...
        String classPathElValue = elClasspath.getTargetValue().blockingGet(getTimeout)
        ...
        classPathElValue=myLibsPrefix.getAbsolutePath()+';'+classPathElValue;
