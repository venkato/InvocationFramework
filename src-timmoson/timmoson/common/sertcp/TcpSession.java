...
//	public static WeakHashMap<TcpSession, Object> tcpSessions= new WeakHashMap();
	...
	public volatile long lastAccessRead;
	public volatile long lastAccessWrite;
	...
	public void updateLastAccessRead(){
		lastAccessRead = System.currentTimeMillis();
	}

	public void updateLastAccessWrite(){
		lastAccessWrite = System.currentTimeMillis();
	}
