...
class MavenSearch {
    ...
    LazyMap findMavenIdsAllArtifactsWithGroupIdRaw(String groupId, int maxResultCount) {
        ...
        LazyMap result = slurper.parse(url) as LazyMap
        return result;
    }

    List<MavenId> findMavenIdsAllArtifactsWithGroupId(String groupId, int maxResultCount) {
        LazyMap raw = findMavenIdsAllArtifactsWithGroupIdRaw(groupId, maxResultCount)
