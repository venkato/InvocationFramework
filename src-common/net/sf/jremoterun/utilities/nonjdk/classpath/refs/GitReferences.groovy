...
//    public static GitRef jtermSrc = new GitRef('https://github.com/JetBrains/jediterm', 'terminal/src')
    ...
    /*
    @Deprecated
    public static GitSpec jtermGitSpec = GitSomeRefs.jtermGitSpec.getGitSpec();

    @Deprecated
    public static GitSpec ifFramework = GitSomeRefs.ifFramework.gitSpec;

    @Deprecated
    public static GitSpec starter = GitSomeRefs.starter.gitSpec;

    @Deprecated
    public static GitSpec rdesktop = GitSomeRefs.rdesktop.gitSpec



    @Deprecated
    public static GitSpec jhexViewer = GitSomeRefs.jhexViewer.gitSpec

    @Deprecated
    public static GitSpec dockingFrames = GitSomeRefs.dockingFrames.gitSpec;
*/
