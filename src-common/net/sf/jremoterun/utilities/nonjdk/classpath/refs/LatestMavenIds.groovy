...
//    eclipseJavaCompiler('org.eclipse.jdt.core.compiler:ecj:4.6.1')
    ...
    , jna("net.java.dev.jna:jna:4.5.2")
    , jnaPlatform("net.java.dev.jna:jna-platform:4.5.2")
    ...
    , httpWinSupport('org.apache.httpcomponents:httpclient-win:4.5.6')
    ...
    , groovySshShell('me.bazhenov.groovy-shell:groovy-shell-server:2.0.0')
    , dropbox('com.dropbox.core:dropbox-core-sdk:3.0.10')
    , javaCompiler1('com.github.javaparser:javaparser-core:3.6.26')
    , javaCompiler2Janino('org.codehaus.janino:janino:3.0.10')
    ...
    , opencsv("com.opencsv:opencsv:4.3.2")
