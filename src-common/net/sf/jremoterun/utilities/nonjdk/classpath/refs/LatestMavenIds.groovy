...
enum LatestMavenIds implements MavenIdContains, ToFileRef2 {
    ...
    , swtWin('org.eclipse.platform:org.eclipse.swt.win32.win32.x86_64:3.108.0')
    , eclipseWorkbench('org.eclipse.platform:org.eclipse.ui.workbench:3.112.0')
    , awsS3('com.amazonaws:aws-java-sdk-s3:1.11.275')
    , jnrJffi('com.github.jnr:jffi:1.2.22')
...
//    eclipseJavaCompiler('org.eclipse.jdt.core.compiler:ecj:4.6.1')
    ...
    , jna("net.java.dev.jna:jna:5.5.0")
    , jnaPlatform("net.java.dev.jna:jna-platform:5.5.0")
    , jline2('jline:jline:2.12')
    , jline3('org.jline:jline:3.9.0')
    , zip4j('net.lingala.zip4j:zip4j:2.3.0')
    ...
    , httpWinSupport('org.apache.httpcomponents:httpclient-win:4.5.11')
    , httpCore('org.apache.httpcomponents:httpcore:4.4.13')
    , httpCoreNio('org.apache.httpcomponents:httpcore-nio:4.4.13')
    , httpClient("org.apache.httpcomponents:httpclient:4.5.11")
    ...
    , commnonsLang3('org.apache.commons:commons-lang3:3.8.1')
    ...
    , javaCompiler1('com.github.javaparser:javaparser-core:3.8.1')
    ...
    ,
    @Deprecated
    sshd(SshdMavenIds.core)
    , trileadSsh('com.trilead:trilead-ssh2:1.0.0-build222')
    , groovySshShell('me.bazhenov.groovy-shell:groovy-shell-server:2.0.2')
    ...
    , cssParser3('net.sourceforge.cssparser:cssparser:0.9.26')
    ...
    , winKillProcessTree('org.jvnet.winp:winp:1.27')
    ...
    svnCli('org.tmatesoft.svnkit:svnkit-cli:1.9.3')
    , fernflowerJavaDecompiler('org.jboss.windup.decompiler.fernflower:windup-fernflower:1.0.0.20171018')
    , fernflowerLogger('org.jboss.windup.decompiler:decompiler-fernflower:4.3.0.Final')
    , fernflowerJavaDecompilerApi('org.jboss.windup.decompiler:decompiler-api:4.3.0.Final')
    , cfrJavaDecompilerApi('org.benf:cfr:0.146')
...
//    , jasypt('org.jasypt:jasypt:1.9.2')
    ...
    , python('org.python:jython-standalone:2.7.0')
    , args4j('args4j:args4j:2.33')
    , quickfixj('org.quickfixj:quickfixj-all:2.1.1')
    , minaCore('org.apache.mina:mina-core:2.1.3')
    , javaApiCompare('com.github.siom79.japicmp:japicmp:0.14.1')
    , jcabiGithub('com.jcabi:jcabi-github:1.0')
    , lz4Compressor('org.lz4:lz4-java:1.6.0')
    ,
    // maven launcher
    ...
    ,
    dockerJibCore('com.google.cloud.tools:jib-core:0.16.0')
    ,
    dockerJava('com.github.docker-java:docker-java:3.1.5'),
    heapAnalizerUi('org.netbeans.modules:org-netbeans-modules-profiler-heapwalker:RELEASE112'),
    // com.intellij.diagnostic.hprof.Analyzer
    heapAnalizerCore('org.netbeans.modules:org-netbeans-lib-profiler:RELEASE112'),
    // org.eclipse.mat.snapshot.SnapshotFactory
    heapAnalizerMat('com.github.cormoran-io.pepper:pepper-mat:1.23'),
    primitiveCollections('it.unimi.dsi:fastutil:8.3.1'),
    oracleJdbc('com.oracle.database.jdbc.debug:ojdbc8_g:19.7.0.0'),
    zxingCore('com.google.zxing:core:3.4.1'),
    //below 3 svn stiff needed only for compile
    svnNativeClintWrapper('org.tmatesoft.svnkit:svnkit-javahl16:1.10.1'),
    svnClientAdapterJavahlUseless( 'org.netbeans.external:svnClientAdapter-javahl:RELEASE121'),
    svnClientAdapterMainUseless( 'org.netbeans.external:svnClientAdapter-main:RELEASE121'),
...
//            'com.google.oauth-client:google-oauth-client:1.21.0'),
    ...
    public
    static List<? extends MavenIdContains> specific = [CustObjMavenIds.git, junit, CustObjMavenIds.slf4jApi, jnrJffi, portForward, jna, jnaPlatform, gnuGetOpt, jodaTime, rstaui,//
    ...
    public
    static List<? extends MavenIdContains> usefulMavenIdSafeToUseLatest = DropshipClasspath.allLibsWithoutGroovy + loggingPrefix + (List) AntMavenIds.all + (List) SshdMavenIds.all + (List) Log4j2MavenIds.all + (List) specific + (List) CustObjMavenIds.all
