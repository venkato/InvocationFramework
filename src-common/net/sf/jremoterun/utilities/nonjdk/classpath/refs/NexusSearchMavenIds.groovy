...
enum NexusSearchMavenIds implements MavenIdContains, ToFileRef2 {
    ...
    indexer('org.sonatype.nexus.plugins:nexus-indexer-lucene-model:2.14.15-01'),
    restletBridge('org.sonatype.nexus.plugins:nexus-restlet-bridge:2.14.15-01'),
    rest('org.sonatype.nexus:nexus-rest:3.19.1-01'),
    restlet1x('org.sonatype.nexus.plugins:nexus-restlet1x-model:2.14.15-01'),
